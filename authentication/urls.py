...
from authentication.views import logout_user, signup_owner, creer_gerant
...
urlpatterns = [
    ...
    path('signup', signup_owner, name='signup'),
    path('creer_gerant', creer_gerant, name='creer-gerant'),
